...
function Menu({ isToggled }) {
  return (
    <MenuButtonsHolder isToggled={isToggled}>
      <MenuButton component={Link} to="/search/books" variant="text" color="info">도서</MenuButton>
      <MenuButton component={Link} to="/search/equipments" variant="text" color="info">기자재</MenuButton>
